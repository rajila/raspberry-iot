...
namespace dispenserService.Controllers
{
    public class LogsController : ApiController
    {
        ...
        public async Task<IHttpActionResult> SaveLog(DispenserForm dispensor)
        {
            ...
            _log.AmountBowlFood = dispensor.AmountBowlFood;
            _log.AmountDailyWater = dispensor.AmountDailyWater;
            _log.AmountBowlWater = dispensor.AmountBowlWater;
            _log.CurrentAmountFood = dispensor.CurrentAmountFood;
            _log.AmountFoodDownloaded = dispensor.AmountFoodDownloaded;
            _log.CurrentAmountWater = dispensor.CurrentAmountWater;
            _log.AmountWaterDownloaded = dispensor.AmountWaterDownloaded;
            ...
            if (dispensor.DispenseFood == 1)
            {
                ...
                _foodDispenser.AmountBowlFood = dispensor.AmountBowlFood;
            ...
            if (dispensor.DispenseWater == 1)
            {
                ...
                _waterDispenser.AmountDailyWater = dispensor.AmountDailyWater;
                _waterDispenser.AmountBowlWater = dispensor.AmountBowlWater;
                _waterDispenser.CurrentAmountWater = dispensor.CurrentAmountWater;
                _waterDispenser.AmountWaterDownloaded = dispensor.AmountWaterDownloaded;
